...
public class FxWsSecurityHeaderSOAPHandler implements SOAPHandler<SOAPMessageContext> {
...
//	public FxWsSecurityHeaderSOAPHandler() {
//		this.usernameText = appConfig.getConfig(WSCallConstant.FLEXTERA_USERNAME_DEFAULT_KEY);
//		this.passwordText = appConfig.getConfig(WSCallConstant.FLEXTERA_PASSWORD_DEFAULT_KEY);
//	}
	
	public FxWsSecurityHeaderSOAPHandler(String usernameText, String passwordText) {
